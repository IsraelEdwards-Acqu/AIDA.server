    ...
    using global::AIDA.Server.Data;
    using global::AIDA.Server.DTOs;
    using global::AIDA.Server.Helpers;
    using global::AIDA.Server.Models;
    ...
    namespace AIDA.Server.Services
    {
        public class AuthService
        {
            ...
            public async Task<string?> Login(StudentLoginDto dto)
            {
                ...
                return JwtHelper.GenerateToken(student.StudentId.ToString(), key);
            }
        }
    }
